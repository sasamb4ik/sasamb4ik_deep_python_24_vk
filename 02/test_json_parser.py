...
class TestProcessJson(unittest.TestCase):
    ...
    def test_remove_punctuation(self):
        ...
        self.assertEqual(remove_punctuation("С этой строкой ничего не "
                                            "произойдёт"), "С этой строкой ничего не "
                                            "произойдёт")
    ...
    def test_process_json_basic(self):
        json_str = ('{"Воскресенье": "Привет", "работа": "машинлернер", '
                    '"город": '
                    '"Москва"}')
    ...
    def test_process_json_no_tokens(self):
        json_str = ('{"Тут есть ключ": "Тут предложение", "Другой ключик": '
                    '"клавиатура"}')
    ...
    def test_process_json_punctuation(self):
        json_str = ('{"прозвище": "Глеб!!!", "должность_работа": "машинлернер, '
                    'надеюсь в '
    ...
    def test_process_json_empty_keys(self):
        json_str = ('{"спам": "ээээээээээээм", "СПАМОВИЧ": "ну тут вообще '
    ...
    def test_process_json_multiple_tokens(self):
        json_str = ('{"отчество": "леонидович", "описание": "сегодня я '
    ...
    def test_process_json_key_is_sentence(self):
        ...
        required_keys = ['в первой домашке Геннадий Кандауров предложил мне '
        ...
        mock_callback.assert_any_call('в первой домашке Геннадий Кандауров '
    ...
    def test_process_json_token_is_sentence(self):
        ...
        mock_callback.assert_any_call('я устал от долгих легенд в тестах.',
                                      'Геннадий, если вы это '
            'читаете - хорошего вам настроения!!!')
        self.assertEqual(mock_callback.call_count, 1)
